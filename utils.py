...
def get_2norm_ratio(dim):
    ...
    ''' 
    Returns the ratio of the 2-norm of the second closest point to the first closest point
    ...
    -------
    float
        Ratio of the 2-norm of the second closest point to the first closest point
        in a gaussian distribution of dimension dim.
    '''
...
def kl_divergence(pmf1, pmf2):
    ...
    -------
    float
        Kullback-Leibler divergence between pmf1 and pmf2.
    '''
...
def add_outliers(image, n_outliers):
    ...
    scaled to intensities between 0 and 230. The outliers are then added to the image
    as random pixels with intensitities of 255. This simultes outliers in the pixel
    colorspace.

    Parameters
    ----------
    image : numpy.ndarray
        Image to add outliers to.

    n_outliers : int
        Number of outliers to add to the image.
    
    Returns
    -------
    numpy.ndarray
        Image with n_outliers outliers.
    '''
